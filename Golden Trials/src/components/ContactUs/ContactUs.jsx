    ...
    <section id={id} className="min-h-screen px-6 md:px-12 lg:px-20 pt-10 ">
      ...
      <div className="relative">
        <img
          src={Circledeco}
          alt=""
          className="absolute left-[-300px] bottom-[-300px] w-[400px] md:w-[500px] lg:w-[600px] opacity-10 "
        />
      </div>
      <div className="max-w-4xl mx-auto">
        <div className="p-12 text-center">
          ...
          <p
            ...
            className="text-white text-center text-[8px] sm:text-[14px] mb-2.5 md:mb-6 max-w-md mx-auto leading-relaxed">
